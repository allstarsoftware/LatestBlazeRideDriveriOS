...
- (void)viewDidLoad
{
    ...
    [_maleBtn setBackgroundImage:[UIImage imageNamed:@"check.png"] forState:UIControlStateNormal];
    [_femaleBtn setBackgroundImage:[UIImage imageNamed:@"uncheck.png"] forState:UIControlStateNormal];
...
{
    if(![strTypename isEqual:@"Pink"])
    {
        if(_maleBtnSelected==YES)
        {
            [_maleBtn setBackgroundImage:[UIImage imageNamed:@"uncheck.png"] forState:UIControlStateNormal];
            [_femaleBtn setBackgroundImage:[UIImage imageNamed:@"check.png"] forState:UIControlStateNormal];
            _maleBtnSelected=NO;
    ...
    else if([strTypename isEqual:@"Pink"])
    {
        UIAlertView *alert=[[UIAlertView alloc]initWithTitle:@"" message:@"Pink car type is allowed for female users only. Please choose another car type." delegate:self cancelButtonTitle:NSLocalizedStringFromTable(@"OK",[prefl objectForKey:@"TranslationDocumentName"],nil) otherButtonTitles:nil, nil];
        [alert show];
    }
}
...
-(void)localizeString
{
    ...
    //[self.btnclickinfo setTitle:NSLocalizedString(@"INFO", nil) forState:UIControlStateNormal];
    //[self.btnemail_info setTitle:NSLocalizedString(@"INFO_EMAIL", nil) forState:UIControlStateNormal];
...
//            else if(self.txtNumber.text.length<8)
//            {
...
//            }
            ...
            {
                UIAlertView *alert=[[UIAlertView alloc]initWithTitle:@"" message:NSLocalizedStringFromTable(@"PLEASE_TAXI_MODEL",[prefl objectForKey:@"TranslationDocumentName"],nil) delegate:self cancelButtonTitle:NSLocalizedStringFromTable(@"OK",[prefl objectForKey:@"TranslationDocumentName"],nil) otherButtonTitles:nil, nil];
                [alert show];
            }

            else if(self.txtTaxiNumber.text.length<1)
            {
                UIAlertView *alert=[[UIAlertView alloc]initWithTitle:@"" message:NSLocalizedStringFromTable(@"PLEASE_TAXI_NUMBER",[prefl objectForKey:@"TranslationDocumentName"],nil) delegate:self cancelButtonTitle:NSLocalizedStringFromTable(@"OK",[prefl objectForKey:@"TranslationDocumentName"],nil) otherButtonTitles:nil, nil];
                [alert show];
            }
            ...
            {
                UIAlertView *alert=[[UIAlertView alloc]initWithTitle:@"" message:NSLocalizedStringFromTable(@"Please Select Service Type",[prefl objectForKey:@"TranslationDocumentName"],nil) delegate:self cancelButtonTitle:NSLocalizedStringFromTable(@"OK",[prefl objectForKey:@"TranslationDocumentName"],nil) otherButtonTitles:NSLocalizedStringFromTable(@"Cancel",[prefl objectForKey:@"TranslationDocumentName"],nil), nil];
                alert.tag=200;
                [alert show];
            }
...
//            } 
        ...
        else
        {
                    ...
                    [afn getDataFromPath:FILE_REGISTER withParamData:dictparam withBlock:^(id response, NSError *error)
                     {
                         ...
                         if (response)
                         {
                             ...
                             else
                             {
                                 ...
                                 if (err.count==0)
                                 {
                                     UIAlertView *alert=[[UIAlertView alloc]initWithTitle:@"Fail" message:[response valueForKey:@"error"] delegate:self cancelButtonTitle:NSLocalizedStringFromTable(@"OK",[prefl objectForKey:@"TranslationDocumentName"],nil) otherButtonTitles:nil, nil];
                                     [alert show];
                                 }
                                 else
                                 {
                                     UIAlertView *alert=[[UIAlertView alloc]initWithTitle:@"Fail" message:[NSString stringWithFormat:@"%@",[err objectAtIndex:0]] delegate:self cancelButtonTitle:NSLocalizedStringFromTable(@"OK",[prefl objectForKey:@"TranslationDocumentName"],nil) otherButtonTitles:nil, nil];
                                     [alert show];
                                 }
            ...
            {
                UIAlertView *alert=[[UIAlertView alloc]initWithTitle:@"Fail" message:NSLocalizedStringFromTable(@"PLEASE_VALID_EMAIL",[prefl objectForKey:@"TranslationDocumentName"],nil) delegate:self cancelButtonTitle:NSLocalizedStringFromTable(@"OK",[prefl objectForKey:@"TranslationDocumentName"],nil) otherButtonTitles:nil, nil];
                [alert show];
            }
        }
    }
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        [self.typeCollectionView deselectItemAtIndexPath:indexPath animated:NO];
        strTypeId=nil;
        NSLog(@"Not Allowed");
        UIAlertView *alert=[[UIAlertView alloc]initWithTitle:@"" message:@"Pink car type is allowed for female users only. Please choose another car type." delegate:self cancelButtonTitle:NSLocalizedStringFromTable(@"OK",[prefl objectForKey:@"TranslationDocumentName"],nil) otherButtonTitles:nil, nil];
        [alert show];
    ...
    else
    {
        ...
        strTypename=[NSMutableString stringWithFormat:@"%@",[dictType valueForKey:@"name"]];
