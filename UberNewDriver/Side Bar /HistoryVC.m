...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    self.LblAdminCommissionValue.text=[NSString stringWithFormat:@"$ %.2f",[[pastDict valueForKey:@"waiting_price"] floatValue]];
    self.LblDriverCommissionValue.text=[NSString stringWithFormat:@"$ %.2f",[[pastDict valueForKey:@"driver_per_payment"] floatValue]];
