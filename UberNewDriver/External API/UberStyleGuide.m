...
{
    UIColor *regularColor= [UIColor colorWithRed:(248/255.0f) green:(151/255.0f) blue:(36/255.0f) alpha:1.0];
    return regularColor;
}

+(UIColor *)colorSecondary
{
    UIColor *regularColor= [UIColor colorWithRed:(201/255.0f) green:(201/255.0f) blue:(201/255.0f) alpha:1.0];
    return regularColor;
}
